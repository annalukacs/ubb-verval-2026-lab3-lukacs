namespace DatesAndStuff.Tests
{
    public sealed class SimulationTimeTests
    {
        ...
        [Test]
        public void SimulationTime_LessThanOperator_ShouldReturnTrueWhenFirstIsSmaller()
        {
            // Arrange
            var sut1 = new SimulationTime(2026, 2, 26);
            ...
            // Act
            // Assert
            Assert.IsTrue(sut1 < sut2, "First should be less than second");
        }

        [Test]
        public void SimulationTime_GreaterThanOperator_ShouldReturnTrueWhenFirstIsGreater()
        {
            // Arrange
            var sut1 = new SimulationTime(2026, 2, 27);
            var sut2 = new SimulationTime(2026, 2, 26);
            // Act
            // Assert
            Assert.IsTrue(sut1 > sut2, "First should be greater than second");
        }

        [Test]
        public void SimulationTime_LessThanOrEqualOperator_ShouldReturnTrueForEqualInstances()
        {
            // Arrange
            var sut1 = new SimulationTime(2026, 2, 26);
            var sut2 = new SimulationTime(2026, 2, 26);
            // Act
            // Assert
            Assert.IsTrue(sut1 <= sut2, "Should be less than or equal");
        }

        [Test]
        public void SimulationTime_NotEqualsOperator_ShouldReturnTrueForDifferentInstances()
        {
            // Arrange
            var sut1 = new SimulationTime(2026, 2, 26);
            var sut2 = new SimulationTime(2026, 2, 27);
            // Act
            // Assert
            Assert.IsTrue(sut1 != sut2, "Should not be equal");
        }

        [Test]
        public void SimulationTime_Max_ShouldReturnTheGreaterValue()
        {
            // Arrange
            var sut1 = new SimulationTime(2026, 2, 26);
            var sut2 = new SimulationTime(2026, 2, 27);
            ...
            // Assert
            Assert.AreEqual(sut2, result, "Max should return the greater value");
        }
